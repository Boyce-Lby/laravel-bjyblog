        ...
        <footer id="b-foot" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <ul>
                <li class="text-center">
                    本站使用baijunyao开发的<a rel="nofollow" href="https://github.com/baijunyao/laravel-bjyblog" target="_blank">laravel-bjyblog</a>开源博客程序搭建  © 2014-2017 版权所有 ICP证：{{ htmlspecialchars_decode($config['WEB_ICP_NUMBER']) }}
                </li>
                <li class="text-center">
